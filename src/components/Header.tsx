      ...
      <div className="border-b border-[#EAE6DF] px-4 py-1.5 text-xs text-[#716F68]">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#E2D8FA] bg-[#F3EFFF] px-2.5 py-0.5 font-mono text-xs text-[#6842C2] font-semibold">
              <span className="h-1.5 w-1.5 rounded-full bg-[#6842C2]"></span>
              DataForge 2026 · Pathway Track
            </span>
            <span className="hidden text-[#D8D4CB] sm:inline">|</span>
            <span className="hidden font-mono text-xs text-[#716F68] sm:inline">
              Pathway BDH Scientific Laboratory
            </span>
          </div>

          <div className="flex items-center gap-3">
            <span className="rounded-lg border border-[#CFE8E8] bg-[#EDF7F7] px-2 py-0.5 font-mono text-xs text-[#167C80] font-bold">
              100% In-Browser Deterministic
            </span>
            <button
              id="reduced-motion-toggle"
              onClick={onToggleReducedMotion}
              className={`flex items-center gap-1 rounded-lg border px-2.5 py-0.5 text-xs font-mono transition-colors cursor-pointer ${
                reducedMotion
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-serif text-lg font-bold tracking-tight text-[#151515] sm:text-xl">
                Memory in Motion
              </span>
              <span className="rounded-md border border-[#EAE6DF] bg-[#FAF8F5] px-1.5 py-0.5 font-mono text-xs uppercase text-[#716F68]">
                v1.2 Lab
              </span>
            </div>
          ...
          <div className="flex max-w-xl items-start gap-2.5 rounded-xl border border-[#E2D8FA] bg-[#F3EFFF]/50 p-2.5 sm:p-3 shadow-xs">
            ...
            <div className="text-xs leading-relaxed text-[#2A2926] font-sans">
              <strong className="font-mono text-[#6842C2] font-semibold">Central Falsifiable Claim: </strong>
              <span>
